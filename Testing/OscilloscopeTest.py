class TestRigolOscilloscope(unittest.TestCase):
    ...
    def test_get_identification(self):
        self.mock_instrument.query.return_value = "RIGOL TECHNOLOGIES,DS1054Z,DS1ZA123456789,00.04.04.00.02"
    ...
    def test_clear_status_byte(self):
        ...
        self.mock_instrument.write.assert_called_with("*CLS")
    ...
    def test_operation_complete(self):
        ...
        self.mock_instrument.query.assert_called_with("*OPC?")

    def test_wait_for_completion(self):
        self.scope.wait_for_completion()
        self.mock_instrument.write.assert_called_with("*WAI")

    def test_save_setup(self):
        self.scope.save_setup(5)
        self.mock_instrument.write.assert_called_with("*SAV 5")
        with self.assertRaises(ValueError):
            self.scope.save_setup(10)

    def test_recall_setup(self):
        self.scope.recall_setup(3)
        self.mock_instrument.write.assert_called_with("*RCL 3")
        with self.assertRaises(ValueError):
            self.scope.recall_setup(-1)

    def test_learn_setup(self):
        self.mock_instrument.query.return_value = "SETUP_STRING"
        self.assertEqual(self.scope.learn_setup(), "SETUP_STRING")
        self.mock_instrument.query.assert_called_with("*LRN?")

    def test_trigger_instrument(self):
        self.scope.trigger_instrument()
        self.mock_instrument.write.assert_called_with("*TRG")

    def test_self_test(self):
        self.mock_instrument.query.return_value = "0"
        self.assertEqual(self.scope.self_test(), "0")
        self.mock_instrument.query.assert_called_with("*TST?")

    # --- System Commands Tests ---
    def test_get_lan_ip_address(self):
        self.mock_instrument.query.return_value = "192.168.1.100"
        self.assertEqual(self.scope.get_lan_ip_address(), "192.168.1.100")
        self.mock_instrument.query.assert_called_with(":SYST:COMM:LAN:IPAD?")

    def test_get_lan_subnet_mask(self):
        self.mock_instrument.query.return_value = "255.255.255.0"
        self.assertEqual(self.scope.get_lan_subnet_mask(), "255.255.255.0")
        self.mock_instrument.query.assert_called_with(":SYST:COMM:LAN:SMAS?")

    def test_get_lan_gateway(self):
        self.mock_instrument.query.return_value = "192.168.1.1"
        self.assertEqual(self.scope.get_lan_gateway(), "192.168.1.1")
        self.mock_instrument.query.assert_called_with(":SYST:COMM:LAN:GAT?")

    def test_get_lan_mac_address(self):
        self.mock_instrument.query.return_value = "00:11:22:33:44:55"
        self.assertEqual(self.scope.get_lan_mac_address(), "00:11:22:33:44:55")
        self.mock_instrument.query.assert_called_with(":SYST:COMM:LAN:MAC?")

    def test_set_lan_dhcp_state(self):
        self.scope.set_lan_dhcp_state('ON')
        self.mock_instrument.write.assert_called_with(":SYST:COMM:LAN:DHCP ON")
        self.scope.set_lan_dhcp_state(0)
        self.mock_instrument.write.assert_called_with(":SYST:COMM:LAN:DHCP OFF")
    ...
    def test_get_lan_dhcp_state(self):
        self.mock_instrument.query.return_value = "ON"
        self.assertEqual(self.scope.get_lan_dhcp_state(), "ON")
        self.mock_instrument.query.assert_called_with(":SYST:COMM:LAN:DHCP?")

    def test_set_lan_ip_address(self):
        self.scope.set_lan_ip_address("192.168.1.200")
        self.mock_instrument.write.assert_called_with(":SYST:COMM:LAN:IPAD '192.168.1.200'")

    def test_set_lan_subnet_mask(self):
        self.scope.set_lan_subnet_mask("255.255.255.128")
        self.mock_instrument.write.assert_called_with(":SYST:COMM:LAN:SMAS '255.255.255.128'")

    def test_set_lan_gateway(self):
        self.scope.set_lan_gateway("192.168.1.1")
        self.mock_instrument.write.assert_called_with(":SYST:COMM:LAN:GAT '192.168.1.1'")

    def test_set_lan_dns(self):
        self.scope.set_lan_dns("8.8.4.4")
        self.mock_instrument.write.assert_called_with(":SYST:COMM:LAN:DNS '8.8.4.4'")

    def test_get_lan_dns(self):
        self.mock_instrument.query.return_value = "8.8.8.8"
        self.assertEqual(self.scope.get_lan_dns(), "8.8.8.8")
        self.mock_instrument.query.assert_called_with(":SYST:COMM:LAN:DNS?")

    def test_set_lan_port(self):
        self.scope.set_lan_port(1234)
        self.mock_instrument.write.assert_called_with(":SYST:COMM:LAN:PORT 1234")
        with self.assertRaises(ValueError):
    ...
    def test_get_lan_port(self):
        self.mock_instrument.query.return_value = "5555"
        self.assertEqual(self.scope.get_lan_port(), "5555")
        self.mock_instrument.query.assert_called_with(":SYST:COMM:LAN:PORT?")

    def test_set_lan_remote_control_state(self):
        self.scope.set_lan_remote_control_state('ON')
        self.mock_instrument.write.assert_called_with(":SYST:COMM:LAN:REM ON")
    ...
    def test_get_lan_remote_control_state(self):
        ...
        self.mock_instrument.query.assert_called_with(":SYST:COMM:LAN:REM?")

    def test_get_scpi_version(self):
        self.mock_instrument.query.return_value = "1999.0"
        self.assertEqual(self.scope.get_scpi_version(), "1999.0")
        self.mock_instrument.query.assert_called_with(":SYST:VERS?")

    def test_set_date(self):
        self.scope.set_date(2025, 7, 10)
        self.mock_instrument.write.assert_called_with(":SYST:DATE 2025,7,10")
        with self.assertRaises(ValueError):
    ...
    def test_get_date(self):
        self.mock_instrument.query.return_value = "2025,7,10"
        self.assertEqual(self.scope.get_date(), "2025,7,10")
        self.mock_instrument.query.assert_called_with(":SYST:DATE?")

    def test_set_time(self):
        self.scope.set_time(10, 30, 0)
        self.mock_instrument.write.assert_called_with(":SYST:TIME 10,30,0")
        with self.assertRaises(ValueError):
    ...
    def test_get_time(self):
        self.mock_instrument.query.return_value = "10,30,0"
        self.assertEqual(self.scope.get_time(), "10,30,0")
        self.mock_instrument.query.assert_called_with(":SYST:TIME?")

    def test_set_beeper_state(self):
        self.scope.set_beeper_state('ON')
        self.mock_instrument.write.assert_called_with(":SYST:BEEP:STAT ON")
    ...
    def test_get_beeper_state(self):
        ...
        self.mock_instrument.query.assert_called_with(":SYST:BEEP:STAT?")

    def test_set_beeper_volume(self):
        self.scope.set_beeper_volume(75)
        self.mock_instrument.write.assert_called_with(":SYST:BEEP:VOL 75")
        with self.assertRaises(ValueError):
            self.scope.set_beeper_volume(101)

    def test_get_beeper_volume(self):
        self.mock_instrument.query.return_value = "50"
        self.assertEqual(self.scope.get_beeper_volume(), "50")
        self.mock_instrument.query.assert_called_with(":SYST:BEEP:VOL?")

    def test_set_key_lock_state(self):
        self.scope.set_key_lock_state('ON')
        self.mock_instrument.write.assert_called_with(":SYST:KLOC ON")
        self.scope.set_key_lock_state('INVALID')
        self.assertIn("Invalid state: 'INVALID'. Allowed values are: ['ON', 'OFF', 1, 0]", self.mock_stdout.getvalue())

    def test_get_key_lock_state(self):
        self.mock_instrument.query.return_value = "OFF"
        self.assertEqual(self.scope.get_key_lock_state(), "OFF")
        self.mock_instrument.query.assert_called_with(":SYST:KLOC?")

    def test_go_to_local(self):
        self.scope.go_to_local()
        self.mock_instrument.write.assert_called_with(":SYST:GTL")

    def test_set_system_lock_state(self):
        self.scope.set_system_lock_state('ON')
        self.mock_instrument.write.assert_called_with(":SYST:LOC ON")
    ...
    def test_get_system_lock_state(self):
        ...
        self.mock_instrument.query.assert_called_with(":SYST:LOC?")

    def test_set_language(self):
        self.scope.set_language('ENGLish')
        self.mock_instrument.write.assert_called_with(":SYST:LANG ENGLISH")
    ...
    def test_get_language(self):
        self.mock_instrument.query.return_value = "ENGL"
        self.assertEqual(self.scope.get_language(), "ENGL")
        self.mock_instrument.query.assert_called_with(":SYST:LANG?")

    def test_update_system(self):
        self.scope.update_system()
        self.mock_instrument.write.assert_called_with(":SYST:UPD")

    def test_get_model_information(self):
        self.mock_instrument.query.return_value = "DS1054Z"
        self.assertEqual(self.scope.get_model_information(), "DS1054Z")
        self.mock_instrument.query.assert_called_with(":SYST:INF:MOD?")

    def test_get_serial_number(self):
        self.mock_instrument.query.return_value = "DS1ZA123456789"
        self.assertEqual(self.scope.get_serial_number(), "DS1ZA123456789")
        self.mock_instrument.query.assert_called_with(":SYST:INF:SER?")
    ...
    def test_get_option_information(self):
        ...
        self.mock_instrument.query.assert_called_with(":SYST:INF:OPT?")

    def test_get_firmware_version(self):
        self.mock_instrument.query.return_value = "00.04.04.00.02"
        self.assertEqual(self.scope.get_firmware_version(), "00.04.04.00.02")
        self.mock_instrument.query.assert_called_with(":SYST:INF:VER?")

    def test_get_all_information(self):
        self.mock_instrument.query.return_value = "ALL_INFO_STRING"
        self.assertEqual(self.scope.get_all_information(), "ALL_INFO_STRING")
        self.mock_instrument.query.assert_called_with(":SYST:INF:ALL?")

    # --- Display Commands Tests ---
    def test_set_display_type(self):
        self.scope.set_display_type('VECTor')
        self.mock_instrument.write.assert_called_with(":DISP:TYPE VECTOR")
    ...
    def test_get_display_type(self):
        self.mock_instrument.query.return_value = "VECT"
        self.assertEqual(self.scope.get_display_type(), "VECT")
        self.mock_instrument.query.assert_called_with(":DISP:TYPE?")

    def test_set_grid_type(self):
        self.scope.set_grid_type('FULL')
        self.mock_instrument.write.assert_called_with(":DISP:GRID FULL")
    ...
    def test_get_grid_type(self):
        self.mock_instrument.query.return_value = "FULL"
        self.assertEqual(self.scope.get_grid_type(), "FULL")
        self.mock_instrument.query.assert_called_with(":DISP:GRID?")

    def test_set_persistence_state(self):
        self.scope.set_persistence_state('ON')
        self.mock_instrument.write.assert_called_with(":DISP:PERS ON")
    ...
    def test_get_persistence_state(self):
        ...
        self.mock_instrument.query.assert_called_with(":DISP:PERS?")

    def test_set_persistence_time(self):
        self.scope.set_persistence_time(5.0)
        self.mock_instrument.write.assert_called_with(":DISP:PERS:TIME 5.0")
    ...
    def test_get_persistence_time(self):
        self.mock_instrument.query.return_value = "1.0"
        self.assertEqual(self.scope.get_persistence_time(), "1.0")
        self.mock_instrument.query.assert_called_with(":DISP:PERS:TIME?")

    def test_set_display_brightness(self):
        self.scope.set_display_brightness(70)
        self.mock_instrument.write.assert_called_with(":DISP:BRIG 70")
        with self.assertRaises(ValueError):
    ...
    def test_get_display_brightness(self):
        ...
        self.mock_instrument.query.assert_called_with(":DISP:BRIG?")

    def test_set_acquire_intensity(self):
        self.scope.set_acquire_intensity(60)
        self.mock_instrument.write.assert_called_with(":DISP:INT:ACQ 60")
        with self.assertRaises(ValueError):
    ...
    def test_get_acquire_intensity(self):
        ...
        self.mock_instrument.query.assert_called_with(":DISP:INT:ACQ?")

    def test_set_display_intensity(self):
        self.scope.set_display_intensity(80)
        self.mock_instrument.write.assert_called_with(":DISP:INT:DISP 80")
        with self.assertRaises(ValueError):
    ...
    def test_get_display_intensity(self):
        ...
        self.mock_instrument.query.assert_called_with(":DISP:INT:DISP?")

    def test_clear_display(self):
        self.scope.clear_display()
        self.mock_instrument.write.assert_called_with(":DISP:CLE")

    def test_set_color_grade_state(self):
        self.scope.set_color_grade_state('ON')
        self.mock_instrument.write.assert_called_with(":DISP:CGR ON")
    ...
    def test_get_color_grade_state(self):
        ...
        self.mock_instrument.query.assert_called_with(":DISP:CGR?")

    # --- Channel Commands Tests ---
    def test_set_channel_display_state(self):
        self.scope.set_channel_display_state(1, 'ON')
        self.mock_instrument.write.assert_called_with(":CHAN1:DISP ON")
        with self.assertRaises(ValueError):
    ...
    def test_set_channel_coupling(self):
        ...
        self.mock_instrument.write.assert_called_with(":CHAN1:COUP DC")
    ...
    def test_get_channel_coupling(self):
        self.mock_instrument.query.return_value = "DC"
    ...
    def test_set_channel_invert_state(self):
        ...
        self.mock_instrument.write.assert_called_with(":CHAN1:INV ON")
    ...
    def test_set_channel_probe_ratio(self):
        ...
        self.mock_instrument.write.assert_called_with(":CHAN1:PROB 10.0")
    ...
    def test_set_channel_bandwidth_limit_state(self):
        ...
        self.mock_instrument.write.assert_called_with(":CHAN1:BWL ON")
    ...
    def test_set_channel_delay(self):
        ...
        self.mock_instrument.write.assert_called_with(":CHAN1:DEL 1e-06")
    ...
    def test_set_channel_units(self):
        ...
        self.mock_instrument.write.assert_called_with(":CHAN1:UNIT VOLT")
    ...
    def test_get_channel_units(self):
        self.mock_instrument.query.return_value = "VOLT"
    ...
    def test_set_channel_vertical_position(self):
        ...
        self.mock_instrument.write.assert_called_with(":CHAN1:VERT:POS 0.05")
    ...
    def test_set_channel_label(self):
        ...
        self.mock_instrument.write.assert_called_with(":CHAN1:LAB 'Input Signal'")

    def test_get_channel_label(self):
        self.mock_instrument.query.return_value = "CH1_Label"
    ...
    def test_set_channel_resistance(self):
        ...
        self.mock_instrument.write.assert_called_with(":CHAN1:RES FIFTY")
    ...
    def test_get_channel_resistance(self):
        self.mock_instrument.query.return_value = "ONEM"
    ...
    def test_set_timebase_mode(self):
        ...
        self.mock_instrument.write.assert_called_with(":TIM:MODE MAIN")
    ...
    def test_get_timebase_mode(self):
        self.mock_instrument.query.return_value = "MAIN"
        self.assertEqual(self.scope.get_timebase_mode(), "MAIN")

    def test_set_timebase_scale(self):
        self.scope.set_timebase_scale(0.002)
        self.mock_instrument.write.assert_called_with(":TIM:SCAL 0.002")

    def test_get_timebase_scale(self):
        self.mock_instrument.query.return_value = "0.001"
    ...
    def test_set_timebase_offset(self):
        ...
        self.mock_instrument.write.assert_called_with(":TIM:OFFS 0.001")
    ...
    def test_set_timebase_delay_enable(self):
        ...
        self.mock_instrument.write.assert_called_with(":TIM:DEL:ENAB ON")
    ...
    def test_set_timebase_delay_scale(self):
        ...
        self.mock_instrument.write.assert_called_with(":TIM:DEL:SCAL 0.0002")

    def test_get_timebase_delay_scale(self):
        self.mock_instrument.query.return_value = "0.0001"
    ...
    def test_set_timebase_delay_offset(self):
        ...
        self.mock_instrument.write.assert_called_with(":TIM:DEL:OFFS 0.0001")
    ...
    def test_set_trigger_mode(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:MODE EDGE")
    ...
    def test_get_trigger_mode(self):
        self.mock_instrument.query.return_value = "EDGE"
    ...
    def test_set_edge_trigger_source(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:EDGE:SOUR CHAN1")
    ...
    def test_get_edge_trigger_source(self):
        self.mock_instrument.query.return_value = "CHAN1"
    ...
    def test_set_edge_trigger_level(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:EDGE:LEV 0.5")
    ...
    def test_set_edge_trigger_slope(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:EDGE:SLOP POSITIVE")
    ...
    def test_get_edge_trigger_slope(self):
        self.mock_instrument.query.return_value = "POS"
    ...
    def test_set_edge_trigger_coupling(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:EDGE:COUP DC")
    ...
    def test_set_trigger_sweep_mode(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:SWE AUTO")
    ...
    def test_set_nth_edge_trigger_source(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:NTH:SOUR CHAN1")
    ...
    def test_set_nth_edge_trigger_level(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:NTH:LEV 0.2")
    ...
    def test_set_nth_edge_trigger_slope(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:NTH:SLOP NEGATIVE")
    ...
    def test_set_nth_edge_trigger_coupling(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:NTH:COUP AC")
    ...
    def test_set_nth_edge_count(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:NTH:N 3")
        with self.assertRaises(ValueError):
    ...
    def test_set_pulse_trigger_source(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:PULS:SOUR CHAN2")
    ...
    def test_set_pulse_trigger_level(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:PULS:LEV 0.3")
    ...
    def test_set_pulse_width(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:PULS:WIDT 2e-06")
    ...
    def test_set_pulse_polarity(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:PULS:POL NEGATIVE")
    ...
    def test_set_pulse_condition(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:PULS:COND GREATERTHAN")

    def test_get_pulse_condition(self):
        self.mock_instrument.query.return_value = "GREA"
    ...
    def test_set_pulse_coupling(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:PULS:COUP HFREJECT")
    ...
    def test_set_video_trigger_source(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:VID:SOUR EXT")
    ...
    def test_set_video_trigger_level(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:VID:LEV 0.7")
    ...
    def test_set_video_polarity(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:VID:POL INVERTED")

    def test_get_video_polarity(self):
        self.mock_instrument.query.return_value = "NORM"
        self.assertEqual(self.scope.get_video_polarity(), "NORM")

    def test_set_video_standard(self):
        self.scope.set_video_standard('PAL')
        self.mock_instrument.write.assert_called_with(":TRIG:VID:STAN PAL")

    def test_get_video_standard(self):
        self.mock_instrument.query.return_value = "NTSC"
        self.assertEqual(self.scope.get_video_standard(), "NTSC")

    def test_set_video_sync(self):
        self.scope.set_video_sync('ODDfield')
        self.mock_instrument.write.assert_called_with(":TRIG:VID:SYNC ODDFIELD")

    def test_get_video_sync(self):
        self.mock_instrument.query.return_value = "ALL"
    ...
    def test_set_slope_trigger_source(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:SLOP:SOUR CHAN3")
    ...
    def test_set_slope_trigger_level1(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:SLOP:LEV1 0.1")

    def test_get_slope_trigger_level1(self):
        self.mock_instrument.query.return_value = "0.1"
    ...
    def test_set_slope_trigger_level2(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:SLOP:LEV2 -0.1")
    ...
    def test_set_slope_trigger_time(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:SLOP:TIME 1e-05")
    ...
    def test_set_slope_trigger_slope(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:SLOP:SLOP EITHER")
    ...
    def test_set_slope_trigger_condition(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:SLOP:COND INRANGE")

    def test_get_slope_trigger_condition(self):
        self.mock_instrument.query.return_value = "GTR"
    ...
    def test_set_slope_trigger_coupling(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:SLOP:COUP DC")
    ...
    def test_set_over_trigger_source(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:OVER:SOUR CHAN4")
    ...
    def test_set_over_trigger_level1(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:OVER:LEV1 0.2")
    ...
    def test_set_over_trigger_level2(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:OVER:LEV2 -0.2")
    ...
    def test_set_over_trigger_condition(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:OVER:COND OUTRANGE")

    def test_get_over_trigger_condition(self):
        self.mock_instrument.query.return_value = "IN"
    ...
    def test_set_over_trigger_coupling(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:OVER:COUP AC")
    ...
    def test_set_window_trigger_source(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:WIND:SOUR CHAN1")
    ...
    def test_set_window_trigger_level1(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:WIND:LEV1 0.3")
    ...
    def test_set_window_trigger_level2(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:WIND:LEV2 -0.3")
    ...
    def test_set_window_trigger_time(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:WIND:TIME 3e-06")
    ...
    def test_set_window_trigger_condition(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:WIND:COND LESSTHAN")
    ...
    def test_set_window_trigger_coupling(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:WIND:COUP LFREJECT")
    ...
    def test_set_timeout_trigger_source(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:TIM:SOUR CHAN2")
    ...
    def test_set_timeout_trigger_time(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:TIM:TIME 5e-06")
    ...
    def test_set_timeout_polarity(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:TIM:POL NEGATIVE")
    ...
    def test_set_timeout_condition(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:TIM:COND GREATERTHAN")
    ...
    def test_set_timeout_coupling(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:TIM:COUP HFREJECT")
    ...
    def test_set_rs232_trigger_source(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:RS232:SOUR CHAN3")
    ...
    def test_set_rs232_baud_rate(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:RS232:BAUD 115200")
    ...
    def test_set_rs232_display_state(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:RS232:DISP OFF")
    ...
    def test_set_rs232_packet_data(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:RS232:PACK:DATA '0xBB'")

    def test_get_rs232_packet_data(self):
        self.mock_instrument.query.return_value = "0xAA"
    ...
    def test_set_rs232_packet_length(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:RS232:PACK:LENG 2")
        with self.assertRaises(ValueError):
    ...
    def test_set_rs232_packet_offset(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:RS232:PACK:OFFS 1")
        with self.assertRaises(ValueError):
            self.scope.set_rs232_packet_offset(-1)
    ...
    def test_set_rs232_packet_type(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:RS232:PACK:TYPE PARITY")

    def test_get_rs232_packet_type(self):
        self.mock_instrument.query.return_value = "DATA"
    ...
    def test_set_rs232_packet_condition(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:RS232:PACK:COND NOTEQUAL")

    def test_get_rs232_packet_condition(self):
        self.mock_instrument.query.return_value = "EQUAL"
    ...
    def test_set_iic_trigger_source(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:IIC:SOUR CHAN1")
    ...
    def test_set_iic_packet_length(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:IIC:PACK:LENG 3")
    ...
    def test_set_iic_packet_offset(self):
        ...
        self.mock_instrument.write.assert_called_with(":TRIG:IIC:PACK:OFFS 2")"""